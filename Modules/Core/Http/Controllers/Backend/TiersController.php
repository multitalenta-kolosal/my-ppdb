...
use Log;
use Modules\Core\Services\TierService;
use Modules\Core\DataTables\TiersDataTable;
use Modules\Core\Http\Requests\Backend\TiersRequest;
...
class TiersController extends Controller
{
    ...
    public function __construct(TierService $tierService)
    {
        ...
        $this->module_path = 'tiers';

        // module icon
        $this->module_icon = 'fas fa-sitemap';

        // module model name, path
        $this->module_model = "Modules\Core\Entities\Tier";
    ...
    public function index_list(Request $request)
    {
        ...
        $$module_name = $this->tierService->getIndexList($request);
     ...
     * @return Response
     */
    public function store(TiersRequest $request)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        ...
        $tiers = $this->tierService->store($request);
    ...
    public function show($id)
    {
        ...
        $tiers = $this->tierService->show($id);
    ...
    public function edit($id)
    {
        ...
        $tiers = $this->tierService->edit($id);
     ...
     * @return Response
     */
    public function update(TiersRequest $request, $id)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        ...
        $tiers = $this->tierService->update($request,$id);
    ...
    public function destroy($id)
    {
        ...
        $tiers = $this->tierService->destroy($id);
    ...
    public function purge($id)
    {
        ...
        $units = $this->tierService->purge($id);
    ...
    public function purgeAll()
    {
        ...
        $tiers = $this->tierService->purgeAll();
    ...
    public function trashed()
    {
        ...
        $tiers = $this->tierService->trashed();

        $$module_name = $tiers->data;
    ...
    public function restore($id)
    {
        ...
        $tiers = $this->tierService->restore($id);
